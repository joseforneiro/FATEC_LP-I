...
public class Profissional {
	...
	public int anos_estudos;
	
	//Construtor
	public Profissional(String profissao, String area_trabalho, String local_trabalho, String graduacao, int anos_estudos) {
		this.profissao = profissao;
		this.area = area_trabalho;
